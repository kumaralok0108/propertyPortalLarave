                    ...
                    <div class="pro-wrapper">
                        ...
                        <div
                            ...
                            <div class="sorting-options">
                                <a href="{{ url('/frontend/properties-list') }}" class="change-view-btn lde"><i
                                        class="fa fa-th-list"></i></a>
                                <a href="{{ url('/frontend/residential') }}" class="change-view-btn active-view-btn"><i class="fa fa-th-large"></i></a>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="item col-lg-6 col-md-6 col-xs-12 landscapes sale">
                            <div class="project-single" data-aos="fade-up">
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        <!-- homes img -->
                                        <a href="{{ url('/frontend/properties-list') }}" class="homes-img">
                                            <div class="homes-tag button alt featured">Featured</div>
                                            <div class="homes-tag button alt sale" style="background-color: #FF385C !important;">{{ $properties->PropertyTypeName }} </div>
                                            <div class="homes-tag button alt available" style="left:120px;margin-top: 15px; background-color: #18ba60;">Available Now</div>                                            <div class="homes-price">$ {{ $properties->ShortLetPrice }} /-</div>
                                            {{-- <img src="https://realestate.supagrow.in/public/storage/files/{{ $properties->thumb }}"
                                    ...
                                    <div class="button-effect">
                                        <a href="/frontend/single-property" class="btn"><i
