                ...
                <div class="detail-wrapper-body">
                    <div class="listing-title-bar">
                        <div class="text-heading text-left">
                            <p class="pb-2"><a href="{{ '/home' }}">Home </a> &nbsp;/&nbsp;
                                <span>Listings</span></p>
                        </div>
                        <h3>List of Residential</h3>
                    </div>
                </div>
            </div>
        </section>
        <div class="row">
            <div class="col-lg-8 col-md-12 blog-pots">
                    ...
                    <div class="pro-wrapper">
                        ...
                        <div
                            ...
                            <div class="sorting-options">
                                <a href="{{ url('/frontend/properties-list') }}" class="change-view-btn active-view-btn"><i class="fa fa-th-list"></i></a>
                                <a href="{{ url('/frontend/residential') }}" class="change-view-btn lde"><i
                ...
                <div class="row featured portfolio-items">
                    ...
                    <div class="item col-lg-6 col-md-12 col-xs-12 landscapes sale pr-0 pb-0">
                        <div class="project-single mb-0 bb-0" data-aos="fade-up">
                            <div class="project-inner project-head">
                                <div class="homes">
                                    <!-- homes img -->
                                    <a href="{{ url('/frontend/single-property') }}" class="homes-img">
                                        ...
                                        <div class="homes-tag button alt sale" style="background-color: #FF385C !important;">{{ $properties->PropertyTypeName }}</div> 
                                        <div class="homes-price">${{ $properties->ShortLetPrice }}</div> 
                                        <img src="{{env('APP_URL')}}/storage/files/{{$properties->thumb}}" alt="home-1" class="img-responsive"> 
                                    </a>
                                </div>
                                <div class="button-effect">
                                    <a href="{{ url('/frontend/single-property') }}" class="btn"><i
                    ...
                    <!-- homes content -->
                    <div class="col-lg-6 col-md-12 homes-content pb-0 mb-44" data-aos="fade-up">
                        <!-- homes address -->
                        <h3><a href="/frontend/single-property/{{$properties->idPropertyList }}">{{ $properties->Title }}</a></h3>
                        <p class="homes-address mb-3">
                            <a href="{{ url('/frontend/single-property') }}">
