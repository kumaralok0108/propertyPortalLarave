                    ...
                    <div class="pro-wrapper">
                        ...
                        <div
                            ...
                            <div class="sorting-options">
                                <a href="{{ url('/frontend/property-Comm-list-girdview') }}"
                                    class="change-view-btn active-view-btn"><i class="fa fa-th-list"></i></a>
                                <a href="{{ url('/frontend/commercial') }}" class="change-view-btn lde"><i
                                ...
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="/frontend/single-property/{{$properties->idPropertyList }}" class="homes-img">
                                            ...
                                            <div class="homes-tag button alt sale" style="background-color: #FF385C;">
                            ...
                            <div class="recent-post">
                                <div class="recent-main">
                                    <div class="recent-img">
                                        <a href="#"><img src="images/feature-properties/fp-1.jpg"
                                                alt=""></a>
                                    </div>
                                    <div class="info-img">
                                        <a href="#">
                                ...
                                <div class="recent-main my-4">
                                    <div class="recent-img">
                                        <a href="#"><img src="images/feature-properties/fp-2.jpg"
                                                alt=""></a>
                                    </div>
                                    <div class="info-img">
                                        <a href="#">
                                ...
                                <div class="recent-main">
                                    <div class="recent-img">
                                        <a href="#"><img src="images/feature-properties/fp-3.jpg"
                                                alt=""></a>
                                    </div>
                                    <div class="info-img">
                                        <a href="#">
