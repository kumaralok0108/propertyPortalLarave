                    ...
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="pro-wrapper">
                                    <div class="detail-wrapper-body">
                                        <div class="listing-title-bar">
                                            <h3>{{ $properties->Title }}<span
                                                    class="mrg-l-5 category-tag">For{{ $properties->PropertyTypeName }}</span>
                                            </h3>
                                            <div class="mt-0">
                                                <a href="#listing-location" class="listing-address">
                                                    <i class="fa fa-map-marker pr-2 ti-location-pin mrg-r-5"></i>{{ $properties->Address }}
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="single detail-wrapper mr-2" style="margin-left: 0;">
                                        <div class="detail-wrapper-body">
                                            <div class="listing-title-bar">
                                                <h4>$ {{ $properties->ShortLetPrice }}</h4>
                                                <div class="mt-0">
                                                    <a href="#listing-location" class="listing-address">
                                                        {{-- <p>$ 1,200 / sq ft</p> --}}
                                                    </a>
                            ...
                            <div id="listingDetailsSlider" class="carousel listing-details-sliders slide mb-30">
                                ...
                                <div class="carousel-inner">
                                    <div class="active item carousel-item" data-slide-number="0">
                                        ...
                                        width="1000" height="400" alt="home-1" >
                                        
                                    </div>
                                    <div class="item carousel-item" data-slide-number="1">
                                        <img src="{{ asset('assets/frontend/images/single-property/s-2.jpg') }}"
                                            class="img-fluid" alt="slider-listing">
                                    </div>
                                    <div class="item carousel-item" data-slide-number="2">
                                        <img src="{{ asset('assets/frontend/images/single-property/s-3.jpg') }}"
                                            class="img-fluid" alt="slider-listing">
                                    </div>
                                    <div class="item carousel-item" data-slide-number="4">
                                        <img src="{{ asset('assets/frontend/images/single-property/s-4.jpg') }}"
                                            class="img-fluid" alt="slider-listing">
                                    </div>
                                    <div class="item carousel-item" data-slide-number="5">
                                        <img src="{{ asset('assets/frontend/images/single-property/s-5.jpg') }}"
                                            class="img-fluid" alt="slider-listing">
                                    </div>
                                ...
                                <ul class="carousel-indicators smail-listing list-inline">
                                    <li class="list-inline-item active">
                                        <a id="carousel-selector-0" class="selected" data-slide-to="0"
                                            ...
                                            <img src="{{ asset('assets/frontend/images/single-property/s-1.jpg') }}"
                            ...
                            <div class="blog-info details mb-30">
                                ...
                                <p class="mb-3"> {{ $properties->Description }}</p>
                    ...
                    <div class="single homes-content details mb-30">
                        ...
                        <ul class="homes-list clearfix">
                            <li>
                                ...
                                <span class="det">{{ $properties->idPropertyList  }}</span>
                            </li>
                            <li>
                                <span class="font-weight-bold mr-1">Property Type:</span>
                                <span class="det">{{ $properties->PropertyTypeName }}</span>
                            </li>
                            <li>
                                <span class="font-weight-bold mr-1">Property status:</span>
                                <span class="det">for {{ $properties->PropertyTypeName }}</span>
                            </li>
                            <li>
                                <span class="font-weight-bold mr-1">Property Price:</span>
                                <span class="det">${{ $properties->ShortLetPrice }}</span>
                            </li>
                            <li>
                                <span class="font-weight-bold mr-1">Rooms:</span>
                                <span class="det">{{ $properties->NumberOfRooms }}</span>
                            </li>
                            <li>
                                <span class="font-weight-bold mr-1">Bedrooms:</span>
                                <span class="det">{{ $properties->NumberOfBedrooms }}</span>
                            </li>
                            <li>
                                <span class="font-weight-bold mr-1">BathRooms:</span>
                                <span class="det">{{ $properties->NumberOfBathroom }}</span>
                            </li>
                            <li>
                                <span class="font-weight-bold mr-1">Vidoe Link:</span>
                                <span class="det"> <a class="icon-wrap popup-video popup-youtube" href="{{ $properties->VideoLink }}">
                        ...
                        <p class="the-icons">
                            ...
                            <span> &nbsp; Nearest Point : <b> {{ $properties->NearestPoint }}</b></span>
                        </p>
                        <!-- title -->
            ...
            {{-- <section class="reviews comments">
                ...
                <div class="row mb-5">
                    <ul class="col-12 commented pl-0">
                        <li class="comm-inf">
                            <div class="col-md-2">
                                <img src="{{ asset('assets/frontend/images/testimonials/ts-5.jpg" ') }}class="
                                    img-fluid" alt="">
                            </div>
                            <div class="col-md-10 comments-info">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras aliquam, quam congue
                                    dictum luctus, lacus magna congue ante, in finibus dui sapien eu dolor. Integer
                                    tincidunt suscipit erat, nec laoreet ipsum vestibulum sed.</p>
                                <div class="rest"><img
                                        src="{{ asset('assets/frontend/images/single-property/s-1.jpg') }}"
                ...
                <div class="row">
                    <ul class="col-12 commented pl-0">
                        <li class="comm-inf">
                            <div class="col-md-2">
                                <img src="{{ asset('assets/frontend/images/testimonials/ts-4.jpg" ') }}class="
                                    img-fluid" alt="">
                            </div>
                            <div class="col-md-10 comments-info">
                                <div class="conra">
                ...
                <div class="row mt-5">
                    <ul class="col-12 commented mb-0 pl-0">
                        <li class="comm-inf">
                            <div class="col-md-2">
                                <img src="{{ asset('assets/frontend/images/testimonials/ts-3.jpg" ') }}class="
                                    img-fluid" alt="">
                            </div>
                            <div class="col-md-10 comments-info">
                                <div class="conra">
                                ...
                                <div class="resti">
                                    <div class="rest"><img
                                            src="{{ asset('assets/frontend/images/single-property/s-2.jpg') }}"
                                            class="img-fluid" alt=""></div>
                                    <div class="rest"><img
                                            src="{{ asset('assets/frontend/images/single-property/s-3.jpg') }}"
                                            class="img-fluid" alt=""></div>
                                </div>
                            </div>
                        </li>
                        ...
                        {{-- <div class="widget-boxed popular mt-5">
                            ...
                            <div class="widget-boxed-body">
                                <div class="banner"><img
                                        src="{{ asset('assets/frontend/images/single-property/banner.jpg') }}"
                                        alt=""></div>
                            </div>
                        </div> --}}
                        <!-- End: Specials offer -->
                        ...
                        <div class="homes-content">
                            ...
                            <div class="footer">
                                <a href="agent-details.html">
                                    <img src="{{ asset('assets/frontend/images/testimonials/ts-1.jpg') }}" alt=""
                ...
                <div class="item col-lg-4 col-md-6 col-xs-12 people">
                    <div class="project-single">
                        ...
                        <div class="homes-content">
                            ...
                            <div class="footer">
                                <a href="agent-details.html">
                                    <img src="{{ asset('assets/frontend/images/testimonials/ts-2.jpg') }}" alt=""
                ...
                <div class="item col-lg-4 col-md-6 col-xs-12 people landscapes no-pb pbp-3">
                    <div class="project-single no-mb mbp-3">
                        <div class="project-inner project-head">
                            <div class="homes">
                                ...
                                <a href="single-property-1.html" class="homes-img">
                                    <div class="homes-tag button alt sale">For Sale</div>
                                    <div class="homes-price">$9,000/mo</div>
                                    <img src="{{ asset('assets/frontend/images/blog/b-1.jpg') }}" alt="home"
                                        class="img-responsive">
                                </a>
                            </div>
                            <div class="button-effect">
                        ...
                        <div class="homes-content">
                            ...
                            <div class="footer">
                                <a href="agent-details.html">
                                    <img src="{{ asset('assets/frontend/images/testimonials/ts-3.jpg') }}" alt=""
