...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/frontend/css/aos2.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('assets/frontend/css/maps.css') }}">
    <link rel="stylesheet" id="color" href="{{ asset('assets/frontend/css/colors/pink.css') }}">
            ...
            <div id="header" class="head-tr bottom">
                <div class="container container-header">
                    ...
                    <div class="left-side">
                        <!-- Logo -->
                        <div id="logo">
                            <a href="{{ url('/') }}"><img src="{{ asset('assets/frontend/images/logo-white-1.svg') }}" data-sticky-logo="{{ asset('assets/frontend/images/logo-red.svg') }}" alt=""></a>
                        </div>
                        <!-- Mobile Navigation -->
                        ...
                        <nav id="navigation" class="style-1 head-tr">
                            <ul id="responsive">
                                <li><a href="{{ url('/') }}">Home</a> </li>
                                    ...
                                    {{-- <li class="d-none d-xl-none d-block d-lg-block"><a href="{{ url('/frontend/user-change-password') }}">Login</a></li>
                                    <li class="d-none d-xl-none d-block d-lg-block"><a href="">Register</a></li> --}}
                                    <li class="d-none d-xl-none d-block d-lg-block mt-5 pb-4 ml-5 border-bottom-0"><a href="{{ url('/frontend/add-property') }}" class="button border btn-lg btn-block text-center">Add Listing<i class="fas fa-laptop-house ml-2"></i></a></li>
                            </ul>
                        </nav>
                        <!-- Main Navigation / End -->
                    </div>
                    ...
                    <div class="header-user-menu user-menu add d-none d-lg-none d-xl-flex">
                        <div class="lang-wrap">
                            ...
                            <ul class="lang-tooltip lang-action no-list-style">
                                ...
                                <li><a href="#" data-lantext="Fr">Arbic</a></li>
                                </ul>
                        </div>
                    </div>
                    <!-- lang-wrap end-->
