    ...
    <div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
          ...
          <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="index.html"><img src="{{ asset('assets/admin/assets/images/logo-mini.svg') }}" alt="logo" /></a>
        </div>
        <ul class="nav">
       ...
       {{-- <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#ui-location" aria-expanded="false" aria-controls="ui-basic">
                <i class="mdi mdi-crosshairs-gps menu-icon"></i>
             ...
             <div class="collapse" id="ui-location">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                      <a class="nav-link" href="{{('/admin/add-location')}}">Add Location</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="{{('/admin/list-location')}}">View Location</a>
                    </li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#ui-feature" aria-expanded="false" aria-controls="ui-basic">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#ui-property" aria-expanded="false" aria-controls="ui-basic">
                <i class="mdi mdi-home menu-icon"></i>
             ...
             <div class="collapse" id="ui-property">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                      <a class="nav-link" href="{{('/admin/add-property-type')}}">Add Property type</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="{{('/admin/list-property-type')}}">View Property type</a>
                    </li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
             ...
             <div class="collapse" id="ui-asset">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                      <a class="nav-link" href="{{('/admin/add-asset-type')}}">Add Asset Type</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="{{('/admin/list-asstet-type')}}">View Asset Type</a>
                    </li>
                </ul>
              </div>
            </li>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar col-lg-12 col-12 p-lg-0 fixed-top d-flex flex-row">
          <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
            <a class="navbar-brand brand-logo-mini align-self-center d-lg-none" href="index.html"><img src="{{ asset('assets/admin/assets/images/logo-mini.svg') }}" alt="logo" /></a>
            ...
            {{-- <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu navbar-dropdown navbar-dropdown-large preview-list" aria-labelledby="notificationDropdown">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="{{ asset('assets/admin/assets/images/faces/face3.jpg') }}" alt="" class="profile-pic" />
                    </div>
                    <div class="preview-item-content">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="{{ asset('assets/admin/assets/images/faces/face2.jpg') }}" alt="" class="profile-pic" />
                    </div>
                    <div class="preview-item-content">
            ...
            <ul class="navbar-nav navbar-nav-right ml-lg-auto">
              ...
              <li class="nav-item nav-profile dropdown border-0">
                <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown">
                  <img class="nav-profile-img mr-2" alt="" src="{{ asset('assets/admin/assets/images/faces/face1.jpg') }}" />
