    ...
    <div class="row">
        <div class="col">
            <section class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal form-bordered" action="/admin/savecountry" method="POST">
                        @csrf
                        <div class="form-group row pb-3">
                            <label class="col-lg-3 control-label text-lg-end pt-2" for="inputDefault">Country Namee
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-lg-6">
                                <select class="form-control" id="CountryStatus" name="CountryStatus">
