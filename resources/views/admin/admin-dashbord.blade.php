                        ...
                        <header class="card-header bg-primary w-100">
                            ...
                            <div class="widget-profile-info">
                                <div class="profile-picture">
                                    <img src="{{ asset('assets/admin/assets/img/!logged-user.jpg')}}">
                                </div>
                                        ...
                                        <ul class="simple-user-list mb-3">
                                            <li>
                                                <figure class="image rounded">
                                                    {{ asset('assets/admin/assets/img/!sample-user.jpg') }}" alt="Joseph Doe Junior" class="rounded-circle">
                                                </figure>
                                            ...
                                            <li>
                                                <figure class="image rounded">
                                                    {{ asset('assets/admin/assets/img/!sample-user.jpg') }}" alt="Joseph Junior" class="rounded-circle">
                                                </figure>
                                            ...
                                            <li>
                                                <figure class="image rounded">
                                                    {{ asset('assets/admin/assets/img/!sample-user.jpg') }}" alt="Joe Junior" class="rounded-circle">
                                                </figure>
                    ...
                    <ul>
                        <li class="status-online">
                            <figure class="profile-picture">
                                {{ asset('assets/admin/assets/img/!sample-user.jpg')}}" alt="Joseph Doe" class="rounded-circle">
                            </figure>
                            <div class="profile-info">
