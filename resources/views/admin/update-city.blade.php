...
<section role="main" class="content-body card-margin">
            ...
            <section class="card">
                ...
                <div class="card-body">
                    {{-- <!-- @if ($errors->any())
                        ...
                        @endforeach
                    @endif --> --}}
                    <form class="form-horizontal form-bordered" method="POST" action="/admin/updatecities">
                        @csrf
                        <input type="hidden" name="Cityid" value="{{$citiesdata->Cityid}}">
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-lg-6">
                             <select class="form-control" id="stateId" name="stateId">
                                    ...
                                    <option value="{{ $states->stateId }}" @if($states->stateId==$citiesdata->stateId) selected @endif>{{ $states->StateName }}</option>
                                    @endforeach
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" id="CityName"
                                    value="{{$citiesdata->CityName}}" name="CityName" />
                            </div>
                        </div>
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-lg-6">
                                <select class="form-control" id="CityStatus" name="CityStatus">
                                    ...
                                    <option value="1" @if($citiesdata->CityStatus==1) selected @endif>Active</option>
                                    <option value="2" @if($citiesdata->CityStatus==2) selected @endif>UnActive</option>
                                </select>
                                <br>
    ...
    <input type="hidden" id="get_state_city_url_admin" value="{{ env('APP_URL') }}/admin/get-state-city-by-country">
